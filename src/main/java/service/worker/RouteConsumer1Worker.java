...
public class RouteConsumer1Worker extends AbstractWorker implements Runnable {
	private static Logger log = LoggerFactory.getLogger(RouteConsumer1Worker.class);
	...
	public void simpleConsumerTest() {
		...
		while (true) {
			...
			log.info("route #1 consumed message " + message);
			try {
				Thread.sleep(100);
